                ...
                <div class="col-sm-12">
                    <section class="panel">
                        ...
                        <div class="panel-body">
                            <div class="form">
                                <form class="cmxform form-horizontal "  id="enrollForm"  method="post" action="{{URL::to('/')}}/employee/new" enctype="multipart/form-data">
                                    @csrf
                                    <div class="form-group ">
                                        <label for="firstname" class="control-label col-lg-3">Employee No</label>
                                        <div class="col-lg-8">
                                            <input class=" form-control" id="employee_no" name="employee_no" type="text" placeholder="Employee's No"/>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-lg-3 control-label">Name</label>
                                        <div class="col-lg-8">
                                            <input type="text" class="form-control" placeholder="Employee's Name" id="name" name="name">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-lg-3 control-label">Position</label>
                                        <div class="col-lg-8">
                                            <input type="text" class="form-control" placeholder="Job Position" id="position" name="position">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-lg-3 control-label">Salary</label>
                                        <div class="col-lg-8">
                                            <input type="text" class="form-control" placeholder="Salary" id="salary" name="salary">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-lg-3 control-label">Residential Address</label>
                                        <div class="col-lg-8">
                                            <input type="text" class="form-control" placeholder="Residential Address" name="residentialaddress" id="residentialaddress">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-4 col-xs-11">
                                            <input class="form-control form-control-inline input-medium default-date-picker"  size="16" type="text" name="startdate" value="" id="startdate" readonly />
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-4 col-xs-11">                                            
                                            <input type="text" class="default-date-picker form-control" placeholder="Date of Birth" name="dateofbirth" id="dateofbirth" readonly size="16" >
