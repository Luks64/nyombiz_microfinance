                                    ...
                                    @if(count($employees) > 0)
                                    	@foreach($employees as $key => $employee)
    		                                ...
    		                                <tr class="">
    		                                    ...
    		                                    <td class="noprint"><a href="#">Delete |</a><span>&nbsp;&nbsp;</span><a href="{{URL::to('/')}}/employee/details/{{ $employee->id }}">Details |</a><span>&nbsp;&nbsp;</span><a href="{{URL::to('/')}}/employee/edit/{{ $employee->id }}">Edit</a></td>
    		                                </tr>
                                    	@endforeach
                                    @else
