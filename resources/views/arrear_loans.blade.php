                            ...
                            <div class="clearfix noprint">
                                <div class="btn-group pull-right">
                                    ...
                                    <ul class="dropdown-menu pull-right">
                                        <li><a href="{{URL::to('/')}}/print/arrear/loans">Print</a></li>
                                        <li><a href="{{URL::to('/')}}/save/arrear/loans">Save as PDF</a></li>
                                    </ul>
                                </div>
                            </div>
                                    ...
                                    @if(count($loans) > 0)
                                        ...
                                        ?>
                                            <tr class="">
                                                ...
                                                <td class="center">{{ number_format($loan->penalty, 2) }}</td>
                                                ...
                                                <td class="noprint"><a class="" href="{{URL::to('/')}}/repayment/{{ $loan->id }}">Repay</a><span>&nbsp;&nbsp;</span><a class="" href="{{URL::to('/')}}/old_applicant/{{ $loan->applicant_id }}">Details |</a><span>&nbsp;&nbsp;</span><a class="" href="{{URL::to('/')}}/applicant/edit/{{ $loan->applicant_id }}">Edit</a></td>
                                            </tr>
                                        @endforeach
                                    @else
