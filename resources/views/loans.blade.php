                                    ...
                                    @if(count($loans) > 0)
                                        ...
                                        ?>
    		                                <tr class="">
    		                                    ...
    		                                    <td class="noprint"><a href="{{URL::to('/')}}/repayment/{{ $loan->id }}">Repay |</a><span>&nbsp;&nbsp;</span><a href="{{URL::to('/')}}/old_applicant/{{ $loan->id }}">Details |</a><span>&nbsp;&nbsp;</span><a href="{{URL::to('/')}}/loan/edit/{{ $loan->id }}">Edit</a></td>
    		                                </tr>
                                    	@endforeach
                                    @else
