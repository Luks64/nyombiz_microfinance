...
<div class="row">
    <div class="col-md-3">
        <div class="mini-stat clearfix">
            ...
            <div class="mini-stat-info">
                <span>{{number_format($principal_out)}}</span>
                Principal Out
            </div>
        </div>
    </div>
    <div class="col-md-3">
        <div class="mini-stat clearfix">
            ...
            <div class="mini-stat-info">
                <span>{{number_format($principal_in)}}</span>
                Principal In
            </div>
        </div>
    </div>
    <div class="col-md-3">
        <div class="mini-stat clearfix">
            ...
            <div class="mini-stat-info">
                <span>{{number_format($principal_out - $principal_in)}}</span>
...
<div class="row">
    <div class="col-md-3">
        <div class="mini-stat clearfix">
            <span class="mini-stat-icon orange"><i class="fa fa-th"></i></span>
            <div class="mini-stat-info">
                <span>{{number_format($groups)}}</span>
                Number Of Groups
            </div>
        </div>
    </div>
    <div class="col-md-3">
        <div class="mini-stat clearfix">
            ...
            <div class="mini-stat-info">
                <span>{{number_format($employees)}}</span>
                Number of Employees
            </div>
        </div>
    </div>
    <div class="col-md-3">
        <div class="mini-stat clearfix">
            <span class="mini-stat-icon pink"><i class="fa fa-money"></i></span>
            <div class="mini-stat-info">
                <span>{{number_format($total_interest_due)}}</span>
...
<div class="row">
    <div class="col-md-3">
        <div class="mini-stat clearfix">
            <span class="mini-stat-icon orange"><i class="fa fa-money"></i></span>
            <div class="mini-stat-info">
                <span>{{number_format($net_given_out)}}</span>
                Net Given Out
            </div>
        </div>
    </div>
    <div class="col-md-3">
        <div class="mini-stat clearfix">
            <span class="mini-stat-icon tar"><i class="fa fa-user"></i></span>
            <div class="mini-stat-info">
                <span>{{number_format($total_interest_due + $principal_out - $principal_in)}}</span>
                Total Outstanding
            </div>
        </div>
    </div>
        ...
        <section class="panel">
            <div class="panel-body">
                <div class="monthly-stats pink">
                    <div class="clearfix">
                        <h4 class="pull-left"> {{ date("F Y") }}</h4>
                        <!-- Nav tabs -->
                    ...
                    <ul class="conversation-list">
                        <li class="clearfix">
                            <div class="chat-avatar">
                                <img src="assets/images/chat-user-thumb.png" alt="male">
                                <i>10:00</i>
                            </div>
                        ...
                        <li class="clearfix odd">
                            <div class="chat-avatar">
                                <img src="assets/images/chat-user-thumb-f.png" alt="female">
                                <i>10:00</i>
                            </div>
                            <div class="conversation-text">
                                <div class="ctext-wrap">
...
<div class="row">
    <div class="col-md-8">
        <section class="panel">
            <div class="wdgt-row">
                <img src="assets/images/weather_image.jpg" height="243" alt="">
                <div class="wdt-head">
                    weather forecast
                </div>
...
@section('page_script')
    <script src="{{URL::asset('assets/js/jvector-map/jquery-jvectormap-1.2.2.min.js')}}"></script>
    <script src="{{URL::asset('assets/js/jvector-map/jquery-jvectormap-us-lcc-en.js')}}"></script>
    <script src="{{URL::asset('assets/js/gauge/gauge.js')}}"></script>
    <!--clock init-->
    <script src="{{URL::asset('assets/js/css3clock/js/css3clock.js')}}"></script>
    <!--Easy Pie Chart-->
    ...
    <!--Morris Chart-->
    <script src="{{URL::asset('assets/js/morris-chart/morris.js')}}"></script>
    <script src="{{URL::asset('assets/js/morris-chart/raphael-min.js')}}"></script>
    <!--jQuery Flot Chart-->
    ...
    <script src="{{URL::asset('assets/js/flot-chart/jquery.flot.animator.min.js')}}"></script>
    <script src="{{URL::asset('assets/js/flot-chart/jquery.flot.growraf.js')}}"></script>
