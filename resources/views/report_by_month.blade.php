            ...
            <div class="panel-body">
                <form class="form-horizontal bucket-form" method="get">
                    <div class="form-group">
                        <label class="col-sm-3 control-label col-lg-3" for="year">Select Year</label>
                        <div class="col-lg-6">
                            <select class="form-control m-bot15" name="year" id="year">
                    ...
                    <div class="panel-body">
                        <div class="adv-table editable-table ">
                            ...
                            <table class="table table-striped table-hover table-bordered" id="">
                                ...
                                <tbody>
                                    @if(count($monthly_loans) > 0)
                                    	@foreach($monthly_loans as $key => $report)
                                       
    		                                <tr class="">
                                                <td>{{$key + 1}}</td>
                                                <td>{{ \DateTime::createFromFormat('!m', $report->loan_months)->format('M')  }}</td>
